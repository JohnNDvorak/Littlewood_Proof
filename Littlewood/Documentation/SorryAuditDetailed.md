...
19 sorries across 9 files. Categorized by fixability.
...
| RiemannVonMangoldtV2 | `N_eq_main_plus_S` | 75 | Stirling + logarithm identities |
...
| PsiThetaBound | `psi_eq_sum_log_p_mul_count` | 108 | Finset.biUnion bijection for prime powers |
| ZeroFreeRegionV2 | `zeta_log_deriv_341` | 117 | Fubini sum interchange (summability proofs) |
...
| Medium effort | 4 | MeanSquare(1), PsiThetaBound, ZeroFreeRegionV2, RiemannVonMangoldtV2 | Computational — could try |
...
| **Net actionable** | **4** | | Computational fixes worth attempting |
