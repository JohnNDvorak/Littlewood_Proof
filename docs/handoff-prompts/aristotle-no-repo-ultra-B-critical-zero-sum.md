# Aristotle Prompt B (Ultra Self-Contained, No Repo Access)
...
## Task
Complete **`critical_zero_sum_diverges`** with no `axiom`, `admit`, or `sorry`, preserving the declaration signature exactly.

## Output Requirements
1. Return Lean code that replaces the `sorry` in `critical_zero_sum_diverges`.
...
- `Littlewood/Aristotle/CosPiSqSign.lean`
- `Littlewood/Aristotle/DirichletPhaseAlignment.lean`
- `Littlewood/Aristotle/GammaHalfPlane.lean`
- `Littlewood/Aristotle/HalfPlaneConnected.lean`
- `Littlewood/Aristotle/HardyCosSmooth.lean`
- `Littlewood/Aristotle/HardyEstimatesPartial.lean`
- `Littlewood/Aristotle/HardyFirstMomentUpperLeaf.lean`
- `Littlewood/Aristotle/HardyInfiniteZerosV2.lean`
- `Littlewood/Aristotle/HardyMeanSquareAsymptoticLeaf.lean`
- `Littlewood/Aristotle/HardyMeanSquareLeafFromAsymptotic.lean`
...
- `Littlewood/Aristotle/HardyZReal.lean`
- `Littlewood/Aristotle/HardyZRealV2.lean`
- `Littlewood/Aristotle/IntervalPartition.lean`
- `Littlewood/Aristotle/LandauAbscissaConvergence.lean`
- `Littlewood/Aristotle/LandauAbscissaProof.lean`
- `Littlewood/Aristotle/LandauLogZetaObstruction.lean`
- `Littlewood/Aristotle/LandauSchmidtDirect.lean`
- `Littlewood/Aristotle/MellinIntegralFormulas.lean`
- `Littlewood/Aristotle/NonNegDirichletIntegral.lean`
- `Littlewood/Aristotle/PringsheimAtoms.lean`
- `Littlewood/Aristotle/PringsheimPsiAtom.lean`
- `Littlewood/Aristotle/PringsheimTheorem.lean`
- `Littlewood/Aristotle/PsiIntegralRepresentation.lean`
- `Littlewood/Aristotle/RHCaseOscillation.lean`
- `Littlewood/Aristotle/RSBlockDecomposition.lean`
- `Littlewood/Aristotle/RSBreakpointDecomposition.lean`
- `Littlewood/Aristotle/RSRemainderAlternating.lean`
- `Littlewood/Aristotle/RiemannSiegelFirstMoment.lean`
- `Littlewood/Aristotle/RiemannSiegelSignCancellation.lean`
- `Littlewood/Aristotle/Standalone/CombinedAtomsFromDeepBlockers.lean`
- `Littlewood/Aristotle/Standalone/ExplicitFormulaAndOscillationFromSubSorries.lean`
- `Littlewood/Aristotle/Standalone/LandauCauchyAtCenterTwo.lean`
- `Littlewood/Aristotle/Standalone/LandauCauchyCoefficientStep.lean`
- `Littlewood/Aristotle/Standalone/LandauPiCorrectedExtensionChain.lean`
- `Littlewood/Aristotle/Standalone/LandauPringsheimRealLine.lean`
- `Littlewood/Aristotle/Standalone/LandauSigmaLessThanOneGenFunInstantiation.lean`
- `Littlewood/Aristotle/Standalone/LandauSigmaLessThanOneTonelliConcrete.lean`
- `Littlewood/Aristotle/Standalone/LandauSigmaLessThanOneTonelliLIntegral.lean`
- `Littlewood/Aristotle/Standalone/LandauSigmaLtOneFromCauchyDomination.lean`
- `Littlewood/Aristotle/Standalone/LandauSigmaOneMCT.lean`
- `Littlewood/Aristotle/Standalone/PiAtomHardCaseCorrectedCore.lean`
- `Littlewood/Aristotle/Standalone/PsiZeroSumOscillationFromIngham.lean`
- `Littlewood/Aristotle/Standalone/RHPsiWitnessFromZeroSum.lean`
- `Littlewood/Aristotle/Standalone/RHWitnessConstructiveStrict.lean`
- `Littlewood/Aristotle/VanDerCorputInfra.lean`
- `Littlewood/Aristotle/VdcFirstDerivTest.lean`
- `Littlewood/Aristotle/ZetaLogDerivInfra.lean`
- `Littlewood/Aristotle/ZetaLogDerivNonAnalytic.lean`
- `Littlewood/Aristotle/ZetaLogDerivPole.lean`
- `Littlewood/Aristotle/ZetaPoleCancellation.lean`
- `Littlewood/Aristotle/ZetaRealNonvanishing.lean`
- `Littlewood/Basic/ChebyshevFunctions.lean`
- `Littlewood/Basic/LogarithmicIntegral.lean`
- `Littlewood/Basic/OmegaNotation.lean`
- `Littlewood/Bridge/HardyChainHyp.lean`
- `Littlewood/Bridge/HardyFirstMomentWiring.lean`
- `Littlewood/Bridge/HardySetupInstance.lean`
- `Littlewood/Bridge/HardyZTransfer.lean`
...
## Full File: `Littlewood/Aristotle/Standalone/PsiZeroSumOscillationFromIngham.lean`
```lean
/-
Proof of PsiZeroSumOscillationHyp (B5b) from ExplicitFormulaPsiGeneralHyp (B5a)
via Landau's indirect argument.
...
## Full Dependency File: `Littlewood/Aristotle/CosPiSqSign.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/DirichletPhaseAlignment.lean`
```lean
import Mathlib
...
## Full Dependency File: `Littlewood/Aristotle/GammaHalfPlane.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/HalfPlaneConnected.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/HardyCosSmooth.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/HardyFirstMomentUpperLeaf.lean`
```lean
import Mathlib
...
## Full Dependency File: `Littlewood/Aristotle/HardyInfiniteZerosV2.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/HardyMeanSquareAsymptoticLeaf.lean`
```lean
import Mathlib
...
## Full Dependency File: `Littlewood/Aristotle/HardyMeanSquareLeafFromAsymptotic.lean`
```lean
import Mathlib
...
## Full Dependency File: `Littlewood/Aristotle/HardyZReal.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/HardyZRealV2.lean`
```lean
/-
This file was generated by Aristotle.
...
## Full Dependency File: `Littlewood/Aristotle/LandauAbscissaConvergence.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/LandauAbscissaProof.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/LandauLogZetaObstruction.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/LandauSchmidtDirect.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/MellinIntegralFormulas.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/NonNegDirichletIntegral.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/PringsheimAtoms.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/PringsheimPsiAtom.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/PringsheimTheorem.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/PsiIntegralRepresentation.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/RHCaseOscillation.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/RSBreakpointDecomposition.lean`
```lean
/-
    ...
    ∃ A B : ℝ, A > 0 ∧ B ≥ 0 ∧
      ∀ T : ℝ, T ≥ 2 →
        ∃ N : ℕ,
          ...
          |∫ t in Ioc 1 T, ErrorTerm t|
            ≤ A * |∑ k ∈ Finset.range (N + 1), (-1 : ℝ) ^ k * Real.sqrt ((k : ℝ) + 1)| + B :=
  Aristotle.RSBlockDecomposition.errorTerm_alternatingSqrt_decomposition_from_blocks hyp

end Aristotle.RSBreakpointDecomposition
```

## Full Dependency File: `Littlewood/Aristotle/RSRemainderAlternating.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/RiemannSiegelFirstMoment.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/RiemannSiegelSignCancellation.lean`
```lean
/- 
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/CombinedAtomsFromDeepBlockers.lean`
```lean
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/ExplicitFormulaAndOscillationFromSubSorries.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauCauchyAtCenterTwo.lean`
```lean
import Littlewood.Aristotle.ZetaPoleCancellation
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauCauchyCoefficientStep.lean`
```lean
import Mathlib
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauPiCorrectedExtensionChain.lean`
```lean
import Littlewood.Aristotle.LandauSchmidtDirect
import Littlewood.Aristotle.ZetaLogDerivNonAnalytic
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauPringsheimRealLine.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauSigmaLessThanOneGenFunInstantiation.lean`
```lean
import Littlewood.Aristotle.PringsheimPsiAtom
import Littlewood.Aristotle.Standalone.LandauSigmaLessThanOneTonelliConcrete
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauSigmaLessThanOneTonelliConcrete.lean`
```lean
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauSigmaLessThanOneTonelliLIntegral.lean`
```lean
import Mathlib
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauSigmaLtOneFromCauchyDomination.lean`
```lean
import Littlewood.Aristotle.LandauAbscissaProof
import Littlewood.Aristotle.LandauSchmidtDirect
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/LandauSigmaOneMCT.lean`
```lean
import Mathlib
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/PiAtomHardCaseCorrectedCore.lean`
```lean
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/RHPsiWitnessFromZeroSum.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/Standalone/RHWitnessConstructiveStrict.lean`
```lean
...
## Full Dependency File: `Littlewood/Aristotle/VanDerCorputInfra.lean`
```lean
/-
This file was generated by Aristotle.
...
## Full Dependency File: `Littlewood/Aristotle/VdcFirstDerivTest.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/ZetaLogDerivInfra.lean`
```lean
/-
This file was generated by Aristotle.
...
## Full Dependency File: `Littlewood/Aristotle/ZetaLogDerivNonAnalytic.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/ZetaLogDerivPole.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/ZetaPoleCancellation.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Aristotle/ZetaRealNonvanishing.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Basic/LogarithmicIntegral.lean`
```lean
/-
Copyright (c) 2025. All rights reserved.
Released under Apache 2.0 license as described in the file LICENSE.
...
theorem logarithmicIntegral_bigO_one :
  ...
  have hdiv : (fun x => x / log x) =O[atTop] (fun x => x) := by
    ...
    have hnorm2 : ‖x‖ = x := by
      exact norm_of_nonneg hxpos
    calc
      ‖x / log x‖ = x / log x := hnorm1
      _ ≤ x / log 2 := hle'
      _ = (1 / log 2) * x := by simp [div_eq_mul_inv, mul_comm]
      _ = (1 / log 2) * ‖x‖ := by simp [hnorm2]
  exact hli.sub hdiv
...
theorem logarithmicIntegral_sub_divLog_tendsto :
  ...
  have hbound :
    ...
    have hlower :
      ...
      calc
        (x / 2) * (1 / (log x)^2)
            = (x - x / 2) * (1 / (log x)^2) := by simp [hlen]
        _ = ∫ t in (x / 2)..x, (1 / (log x)^2) := by simp
...
## Full Dependency File: `Littlewood/Basic/OmegaNotation.lean`
```lean
/-
Copyright (c) 2025. All rights reserved.
Released under Apache 2.0 license as described in the file LICENSE.
...
## Full Dependency File: `Littlewood/Bridge/HardyChainHyp.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Bridge/HardyFirstMomentWiring.lean`
```lean
import Littlewood.Aristotle.HardyZFirstMoment
...
## Full Dependency File: `Littlewood/Bridge/HardySetupInstance.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/Bridge/HardyZTransfer.lean`
```lean
/-
...
## Full Dependency File: `Littlewood/CoreLemmas/GrowthDomination.lean`
```lean
/-
Copyright (c) 2025. All rights reserved.
Released under Apache 2.0 license as described in the file LICENSE.
